      ...
      <nav className="md:hidden bg-pepe-dark border-b border-pepe-line sticky top-0 z-50">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <div className="fixed top-16 left-0 right-0 bottom-0 bg-pepe-dark z-50 overflow-y-auto">
              <div className="px-6 py-8">
                    ...
                    >
                      {item.external ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`flex items-center justify-between w-full px-6 py-5 rounded-xl text-lg font-medium transition-all duration-normal ${
                            item.highlight
                ...
                {/* Mobile Menu Footer */}
                <div className="mt-12 pt-8 border-t border-pepe-line2">
                  <div className="text-center">
                    <p className="text-pepe-t64 text-base mb-4">Zeitgenössischer Zirkus aus München</p>
                    <div className="flex justify-center space-x-6">
                      <a
                        href="mailto:info@pepearts.de"
                        className="text-pepe-t80 hover:text-pepe-gold text-base transition-colors duration-normal"
                      >
                        Kontakt
                      </a>
